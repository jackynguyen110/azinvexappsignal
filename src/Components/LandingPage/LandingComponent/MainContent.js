...
import avatar from '../../../assets/landingImages/faces/avatar.jpg';
import christian from '../../../assets/landingImages/faces/christian.jpg';
import kendall from '../../../assets/landingImages/faces/kendall.jpg';
        ...
        <div className="section text-center">
          <div className="row">
            <div className="col-md-8 ml-auto mr-auto">
              ...
              <h5 className="description">This is the paragraph where you can write more details about your product.
                Keep you user engaged by providing meaningful information. Remember that by this time, the user is
                curious, otherwise he wouldn&apos;t scroll to get here. Add a button if you want the user to see
                more.</h5>
            </div>
          </div>
            ...
            <div className="row">
                ...
                <div className="team-player">
                  <div className="card card-plain">
                    <div className="col-md-6 ml-auto mr-auto">
                      <img src={avatar} alt="Thumbnail Image"
                    ...
                    <div className="card-body">
                      <p className="card-description">You can write here details about one of your team members. You
                    ...
                    <div className="card-footer justify-content-center">
                      ...
                      <a href="#pablo" className="btn btn-link btn-just-icon"><i
                        className="fa fa-instagram" /></a>
                      <a href="#pablo" className="btn btn-link btn-just-icon"><i
                        className="fa fa-facebook-square" /></a>
                    </div>
                  </div>
                </div>
              </div>
              <div className="col-md-4">
                <div className="team-player">
                  <div className="card card-plain">
                    <div className="col-md-6 ml-auto mr-auto">
                      <img src={christian} alt="Thumbnail Image"
                           className="img-raised rounded-circle img-fluid" />
                    </div>
                    ...
                    <div className="card-footer justify-content-center">
                      ...
                      <a href="#/" className="btn btn-link btn-just-icon"><i className="fa fa-linkedin" /></a>
                    </div>
                  </div>
                </div>
              </div>
              <div className="col-md-4">
                <div className="team-player">
                  <div className="card card-plain">
                    <div className="col-md-6 ml-auto mr-auto">
                      <img src={kendall} alt="Thumbnail Image" className="img-raised rounded-circle img-fluid" />
                    </div>
        ...
        <div className="section section-contacts">
          <div className="row">
            <div className="col-md-8 ml-auto mr-auto">
              ...
              <h4 className="text-center description">Divide details about your product or agency work into parts.
                Write a few lines about each one and contact us about any further collaboration. We will responde
                get back to you in a couple of hours.</h4>
